...
use gpui::{
    actions, div, px, rems, size, Action, AnyElement, AnyView, App,
    AppContext, Bounds, Context, Div, Entity, FocusHandle, Focusable, Global,
    InteractiveElement, IntoElement, KeyBinding, ParentElement, Pixels, Render, RenderOnce,
    SharedString, Size, StyleRefinement, Styled, Window, WindowBounds, WindowKind, WindowOptions,
};
use gpui_component::{
    dock::Panel,
