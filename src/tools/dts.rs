...
use gpui::*;
use gpui_component::{
    button::*, h_flex, input::*, v_flex, ActiveTheme, Icon, IconName, Sizable, StyledExt,
};
            ...
            .child(
                ...
                h_flex().w_full().items_center().justify_between().child(
                    h_flex()
                        .gap_2()
                        .items_center()
                        .child(Icon::new(IconName::Bug).size_6())
                        .child(
                            div()
                                .text_2xl()
                                .font_bold()
...
impl DtsView {
    ...
    fn render_issue_list(&self, cx: &Context<Self>) -> impl IntoElement {
        v_flex().w_full().gap_2().children(
            self.issues
                .iter()
                .map(|issue| self.render_issue_item(issue, cx)),
        )
    }
        ...
        h_flex()
            ...
            .child(
                div()
                    ...
                    .py_1()
                    .rounded_md()
                    .bg(if issue.resolved_at.is_some() {
                        rgb(0x22c55e)
                    } else {
                        rgb(0xf59e0b)
                    })
